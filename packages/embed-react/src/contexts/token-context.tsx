...
export function TokenProvider({
  ...
  const [forceRefetchState, setForceRefetchState] = useState(false);
   ...
   */
  useEffect(() => {
    if (forceRefetchState) {
      generateToken();
    }
    setForceRefetchState(false);
  }, [forceRefetchState, setForceRefetchState, generateToken]);
